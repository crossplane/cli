...
func TestJSONPrinterPrint(t *testing.T) {
	type args struct {
      ...
      "children": [
        {
          "object": {
            "apiVersion": "test.cloud/v1alpha1",
            "kind": "XSimpleResource",
            "metadata": {
              "name": "simple-resource-hash"
            },
            "status": {
              "conditions": [
                {
          ...
          "children": [
            {
              "object": {
                ...
                "metadata": {
                  "annotations": {
                    "crossplane.io/composition-resource-name": "something"
                  },
                  "name": "simple-resource-something-hash"
                },
                "status": {
                  "conditions": [
                    {
