...
//go:embed help/reconcile.md
var helpReconcileDetail string
...
func (c *ReconcileCmd) Help() string {
	return helpReconcileDetail
}

// Run runs the trace command.
func (c *ReconcileCmd) Run(k *kong.Context, logger logging.Logger) error {
