...
//go:embed help/resume.md
var helpResumeDetail string
...
func (c *ResumeCmd) Help() string {
	return helpResumeDetail
}

// Run runs the trace command.
func (c *ResumeCmd) Run(k *kong.Context, logger logging.Logger) error {
...
func (c *ResumeCmd) applyAnnotation(ctx context.Context, k *kong.Context, logger logging.Logger, client client.Client, resources []*resource.Resource) error {
