...
└─ Configuration/crossplane-configuration-aws-network                           v0.7.0    True        True      -        HealthyPackageRevision                                                                              
   ├─ ConfigurationRevision/crossplane-configuration-aws-network-97be9100cfe1   v0.7.0    True        True      Active   HealthyPackageRevision                                                                              
   └─ Provider/crossplane-provider-aws-ec2                                      v0.47.0   True        Unknown   -        UnknownPackageRevisionHealth: ...-helm xpkg.crossplane.io/crossplane-contrib/provider-kubernetes]   
      ├─ ProviderRevision/crossplane-provider-aws-ec2-9ad7b5db2899              v0.47.0   True        False     Active   UnhealthyPackageRevision: ...ider package deployment has no condition of type "Available" yet       
      └─ Provider/crossplane-provider-aws-something                             v0.47.0   True        -         -        ActivePackageRevision                                                                               
`,
				err: nil,
			},
		},
...
Configuration/platform-ref-aws                                                  xpkg.crossplane.io/crossplane/platform-ref-aws            v0.9.0    True        True      -        HealthyPackageRevision                                                                                                                                                                                          
├─ ConfigurationRevision/platform-ref-aws-9ad7b5db2899                          xpkg.crossplane.io/crossplane/platform-ref-aws            v0.9.0    True        True      Active   HealthyPackageRevision                                                                                                                                                                                          
└─ Configuration/crossplane-configuration-aws-network                           xpkg.crossplane.io/crossplane/configuration-aws-network   v0.7.0    True        True      -        HealthyPackageRevision                                                                                                                                                                                          
   ├─ ConfigurationRevision/crossplane-configuration-aws-network-97be9100cfe1   xpkg.crossplane.io/crossplane/configuration-aws-network   v0.7.0    True        True      Active   HealthyPackageRevision                                                                                                                                                                                          
   └─ Provider/crossplane-provider-aws-ec2                                      xpkg.crossplane.io/crossplane/provider-aws-ec2            v0.47.0   True        Unknown   -        UnknownPackageRevisionHealth: cannot resolve package dependencies: incompatible dependencies: [xpkg.crossplane.io/crossplane-contrib/provider-helm xpkg.crossplane.io/crossplane-contrib/provider-kubernetes]   
      ├─ ProviderRevision/crossplane-provider-aws-ec2-9ad7b5db2899              xpkg.crossplane.io/crossplane/provider-aws-ec2            v0.47.0   True        False     Active   UnhealthyPackageRevision: post establish runtime hook failed for package: provider package deployment has no condition of type "Available" yet                                                                  
      └─ Provider/crossplane-provider-aws-something                             xpkg.crossplane.io/crossplane/provider-aws-something      v0.47.0   True        -         -        ActivePackageRevision                                                                                                                                                                                           
`,
				err: nil,
			},
		},
